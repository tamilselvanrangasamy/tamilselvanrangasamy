...
<h1>Bootstrap</h1>: Employed for responsive design and pre-styled components, ensuring a modern and visually appealing layout.
<h1>CSS</h1>: Customized styles to enhance the overall aesthetics and user experience.
